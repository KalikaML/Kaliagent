...
urlpatterns = [
    ...
    path('api/get-request-logs/<int:pk>/', views.get_request_logs_api, name='api_get_request_logs'),
    ...
    path('api/upload-quote/<int:pk>/', views.upload_quote_api, name='api_upload_quote'),
]